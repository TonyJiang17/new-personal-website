...
| epic_03_llm_chat | plans/epic_03_llm_chat | feedback | done | plans/epic_03_llm_chat/02_requirements.md | plans/epic_03_llm_chat/04_work_orders.md | optional | Stage 6 passed (staging + smoke): https://personalwebsiterebuild01-6ocxhszp9.vercel.app |
| epic_04_ui_shell_polish | plans/epic_04_ui_shell_polish | chat | in_review | plans/epic_04_ui_shell_polish/02_requirements.md | plans/epic_04_ui_shell_polish/04_work_orders.md | required | Staging deployed: https://personalwebsiterebuild01-t8k3m2n1p.vercel.app (awaiting smoke) |
