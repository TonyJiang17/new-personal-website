...
function PMReadable() {
  return (
    <div>
      <h2 className="text-lg font-bold text-terminal-accent mb-2">{PM_CONTENT.title}</h2>
      <p className="text-terminal-text text-sm leading-relaxed mb-3">{PM_CONTENT.summary}</p>
